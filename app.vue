  ...
  <div v-if="page && !page.fullpage && route.path !== '/'" class="min-h-screen border-b">
    <div
      ...
      :class="[
        ...
        (page.aside ?? true) && 'md:grid-cols-[280px_minmax(0,1.2fr)] lg:grid-cols-[320px_minmax(0,1.5fr)]',
      ]"
    >
      <aside v-if="page.aside ?? true" class="fixed top-[102px] z-30 -ml-2 hidden h-[calc(100vh-3.5rem)] md:w-[280px] lg:w-[320px] shrink-0 overflow-y-auto md:sticky md:top-[60px] md:block">
