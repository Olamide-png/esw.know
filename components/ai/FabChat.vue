...
function onKey(e: KeyboardEvent) { if (e.key === 'Escape' && isOpen.value) toggle() }
onMounted(() => { loadHistory(); nextTick(() => autoGrow()); window.addEventListener('keydown', onKey) })
