...
::steps{:level="4"}
#### :smart-icon{name="/ESW-Brand_Icons_Dashboard.svg" class="align-middle mr-2"} Settlement report
...
#### :smart-icon{name="https://eshopworldirl.sharepoint.com/:u:/s/MarketingDepartment/IQA357YklFT2RKqdwWGOjDGIAWQRVKFaOXi5iw856KeQydY?e=p2bfAP" class="align-middle mr-2"} Invoice issuance
ESW issues an **invoice for Checkout and Shipping fees** based on the settlement report.

---

#### :smart-icon{name="/ESW-Brand_Icons_Clock.svg"} Net payment timeline
