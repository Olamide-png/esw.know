...
::tabs{variant="line" padded="true"}
  ::div{label="Version A icon="lucide:app-window class="w-full justify-center"}
  ...
  ::div{label="Version A icon="lucide:dock class="w-full justify-center"}
