...
To test this configuration, add the product to the basket, then go to Business Manager > Merchant Tools > Products and set the “ESW List of Countries Where Product Is Restricted” to match the country selected on the storefront.
