...
<h2 class="text-3xl font-bold text-gray-500 mb-2 text-center">Welcome Mat Alert For Returning Shoppers</h2>
...
When preference is set to `True`, the welcome mat will display the following alert to returning shoppers:
