      ...
      <div class="space-y-6 sm:space-y-8">
        ...
        <div class="space-y-2 md:space-y-4">
          ...
          <p class="text-gray-500 dark:text-white">
            ...
            <code class="px-1 py-0.5 rounded bg-gray-100 dark:bg-neutral-800 text-gray-800 dark:text-gray-100 text-xs font-JetBrains Mono">True</code>,
            the welcome mat will display the following alert to returning shoppers. Shoppers can then use the links in the alert to update their shipping country, language, and currency.
          </p>
