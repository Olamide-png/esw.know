...
<div class="max-w-[85rem] px-4 py-4 sm:px-6 lg:px-8 lg:py-4 mx-auto">
  ...
  <ul class="space-y-2 sm:space-y-4 pt-2">
          <li class="flex gap-x-3">
            ...
            <div class="grow">
              <span class="text-sm sm:text-base text-gray-500 dark:text-white">
                <span class="font-bold">Navigate to SFCC Business Manager > Merchant Tools > Site Preferences > Locales.
              </span>
            </div>
          </li>
  ...
  <li class="flex gap-x-3">
            ...
            <div class="grow">
              <p class="text-sm sm:text-base text-gray-500 dark:text-white">
                Select locales and click Apply. If the locales are unavailable. Navigateto SFCC Business Manager > Administration > Global Preferences > Locales.
              </p>
            </div>
          </li>
        </ul>
