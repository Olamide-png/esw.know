...
<div class="flex justify-center items-center min-h-screen bg-white dark:bg-neutral-900">
  <div class="flex flex-col max-w-sm text-gray-900 text-center rounded-2xl bg-indigo-50 p-6 xl:py-9 xl:px-12 transition-all duration-500 hover:bg-gray-100">
    <h3 class="font-manrope text-2xl font-bold mb-6">Locales</h3>

  <!-- List -->
<ul class="mb-0 space-y-6 text-lg text-gray-500">
      <li class="flex items-center justify-center space-x-4">
        <svg class="w-6 h-6 text-indigo-600" fill="none" viewBox="0 0 30 30" xmlns="http://www.w3.org/2000/svg">
        ...
        <span> SFCC Business Manager > Merchant Tools > Site Preferences > Locales</span>
      </li>
...
<li class="flex items-center justify-center space-x-4">
        ...
        <span>Select locales and click Apply</span>
      </li>
...
<li class="flex items-center justify-center space-x-4">
        ...
        <span>Navigate to SFCC Business Manager > Administration > Global Preferences > Locales</span>
      </li>
    </ul>
  </div>
</div>
