...
<section class="py-10 bg-white sm:py-16 lg:py-24">
  ...
  <div class="relative grid grid-cols-1 text-center gap-y-12 md:grid-cols-3 gap-x-12">
                <div>
                    ...
                    <div class="w-full">
                    <img class="w-full h-auto rounded-xl scale-110 hover:scale-200 ease-in duration-500" src="/salesforce9.png" alt="Features Image">
                </div>
  ...
  <div>
                    ...
                    <div class="w-full">
                    <img class="w-full h-auto rounded-xl scale-110 hover:scale-200 ease-in duration-500" src="/salesforcestep2.png" alt="Features Image">
                </div>
    ...
    <div class="max-w-full mx-auto">
      <div class="flex flex-wrap items-center -mx-5">
        <div class="w-full lg:w-1/2 px-5 mb-20 lg:mb-0">
          <div class="max-w-md">
            <span class="text-lg font-bold text-blue-600 dark:text-blue-400">Configure Welcome Message</span>
            <h2 class="mt-12 mb-10 text-5xl font-extrabold leading-tight text-gray-800 dark:text-gray-200">Merchant Tools > Online Marketing > Content Slots</h2>
...
<div class="h-auto w-full rounded-xl mt-4">
  
  <img class="scale-110 hover:scale-200 ease-in duration-500"
            src="/image-20220124-102929.png" />
...
<li class="flex pb-10 mb-8 border-b border-gray-200 dark:border-gray-700">
              ...
              <div class="max-w-full">
                <h3 class="mb-2 text-lg font-bold text-gray-700 dark:text-gray-300">Click Apply</h3>
                <p class="text-lg text-gray-500 dark:text-gray-400">Click Apply to save changes</p>
  </div>
            </li>
          </ul>
        </div>
...
<section class="py-4 overflow-hidden bg-background text-foreground">
  <div class="container px-4 mx-auto">
    <div class="max-w-full mx-auto">
      <div class="flex flex-wrap items-center -mx-5">
        <div class="w-full lg:w-1/2 px-5 mb-20 lg:mb-0">
          <div class="max-w-md">
            <span class="text-lg font-bold text-blue-600 dark:text-blue-400">Configure Landing Page Content</span>
            <h2 class="mt-12 mb-10 text-5xl font-extrabold leading-tight text-gray-800 dark:text-gray-200"></h2>
  ...
  <img class="w-full scale-110 hover:scale-200 ease-in duration-500"
            src="/image-20220124-103122.png" />
