...
<!-- Original image with click -->
<img
  src="/salesforcestep2.png"
  alt="Features Image"
  class="w-full h-auto rounded-xl cursor-zoom-in"
  onclick="document.getElementById('zoomModal').showModal()"
/>

<!-- Zoom Modal -->
<dialog id="zoomModal" class="w-full max-w-5xl rounded-xl backdrop:bg-black/80 p-0 border-0">
  <form method="dialog" class="flex justify-end p-4">
    <button class="text-white text-2xl hover:text-red-400">&times;</button>
  </form>
  <img
    src="/salesforcestep2.png"
    alt="Zoomed View"
