...
announcement:
  ...
  icon: <img class="h-10 w-10" src="/shop_open_online_store_icon_192439.png" alt="" />
actions:
...
<section class="py-20 overflow-hidden bg-background text-foreground rounded-xl shadow-lg">
...
<div class="py-20 overflow-hidden bg-background text-foreground rounded-xl shadow-lg">
  <div class="container px-4 mx-auto">
    <div class="max-w-full mx-auto">
      <div class="flex flex-wrap items-center -mx-5">
        <div class="w-full lg:w-1/2 px-5 mb-20 lg:mb-0">
...
<img class="w-full h-auto scale-100 hover:scale-210 ease-in duration-500 rounded-xl shadow-lg" src="/image-20220124-102929 (1).png" alt="Features Image">
  </div>
</li>
          </ul>
        </div>
