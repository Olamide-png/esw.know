...
<div class="relative max-w-sm">
    ...
    <div class="relative h-full p-3 bg-white border-2 border-violet-500 rounded-lg">
        <div class="flex items-center -mt-1">
            <h3 class="my-2 ml-3 text-lg font-bold text-gray-800 dark:border-neutral-700">Returning shopper alert</h3>
        </div>
        <p class="my-2 text-gray-600 dark:text-white">
