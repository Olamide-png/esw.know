...
<div class="max-w-[85rem] px-4 py-4 sm:px-6 lg:px-8 lg:py-4 mx-auto">
  ...
  <div class="md:grid md:grid-cols-2 md:items-center md:gap-12 xl:gap-32">
    <div class="w-full">
  <img class="w-full h-auto rounded-xl shadow" src="/Screenshot 2025-06-30 182129.png" alt="Features Image">
</div>
    <!-- End Col -->
...
<section class="py-10 bg-white sm:py-16 lg:py-24 rounded-xl shadow">
