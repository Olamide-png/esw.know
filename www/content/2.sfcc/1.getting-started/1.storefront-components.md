---
description: Configure storefront experience.
aside: false
fullpage: true
---
...
<h2 class="text-3xl font-bold text-gray-800 dark:text-neutral-200 mb-2 text-center">Welcome Mat</h2>


<!-- Features -->
<div class="max-w-[85rem] px-4 py-4 sm:px-6 lg:px-8 lg:py-4 mx-auto">
  <div class="flex justify-center">
    <img class="max-w-md w-full object-cover rounded-xl" src="/Screenshot 2025-06-30 182129.png" alt="Features Image">
  </div>
</div>
...
::tabs{variant="line"}
  ...
  ::
  ::div{label="Currency menu" icon="lucide:mouse-pointer-click"}

  ::
  ::div{label="Country selection by URL parameter" icon="lucide:mouse-pointer-click"}
