      ...
      <div class="flex flex-wrap items-center -mx-5">
        <div class="w-full lg:w-1/2 px-5 mb-20 lg:mb-0">
          <div class="max-w-md">
            ...
            <p class="mb-16 text-lg text-gray-600 dark:text-gray-400">After the site data is imported, two content slots are automatically added—one for the welcome landing page and another for the landing page content.</p>
          </div>
        </div>
          ...
          <ul>
            <li class="flex pb-10 mb-8 border-b border-gray-200 dark:border-gray-700">
              ...
              <div class="max-w-full">
                ...
                <div class="h-auto max-w-full rounded-xl mt-4">
