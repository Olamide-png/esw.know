...
<h2 class="text-3xl font-bold text-gray-500 mb-2 text-center">Welcome Mat (Returning Shoppers)</h2>
...
::tabs{variant="line"}
  ...
  ::div{label="Configure Welcome Mat to Display an Alert for Returning Shoppers"}
...
<h2 class="text-3xl font-bold text-gray-500 mb-2 text-center">Header and Footer Widgets</h2>
