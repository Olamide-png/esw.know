...
::
  ...
  div class="prose text-gray-500 prose-sm prose-headings:font-normal prose-headings:text-xl text-center mx-auto">
      <div>
        <h1>Welcome Mat</h1>
...
<section x-data="{ darkMode: false }">
  <div class="w-full mx-auto 2xl:max-w-7xl items-center flex flex-col lg:h-svh justify-center py-4 lg:py-4 relative p-8">
    <div class="prose text-gray-500 prose-sm prose-headings:font-normal prose-headings:text-xl text-center mx-auto">
      <div>
