      ...
      <div class="space-y-6 sm:space-y-8">
        ...
        <div class="space-y-2 md:space-y-4">
          ...
          <p class="text-gray-600 dark:text-neutral-400">
            The welcome mat is a modal window that appears when shoppers visit your online store for the first time. It allows them to select their shipping country, preferred language, and currency. To apply the changes, they click Continue Shopping. These preferences can also be updated later from the header or footer.
          </p>
        </div>
        <!-- End Title -->
