...
<li class="flex gap-x-3">
  ...
  ::div{label="Language menu" icon="lucide:a-large-small"}
    ...
    #content
    All languages/ locale must be enabled for the site that is selected in the configuration.
    ::
...
<li class="flex gap-x-3">
       ...
       If the locales are unavailable, add the required locales by:
...
<li class="flex gap-x-3">
            ...
            <div class="grow">
          <p class="mt-1 text-gray-600 dark:text-neutral-400">
              Navigating to SFCC Business Manager > Administration > Global Preferences > Locales
            </p>
            </div>
          </li>
