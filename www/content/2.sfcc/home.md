...
<section class="py-10 bg-gray-900 sm:py-16 lg:py-24">
      ...
      <div class="flex flex-col justify-between lg:py-5">
        ...
        <div class="mt-auto">
          <div class="flex items-center space-x-1">
            <span class="text-sm font-medium text-gray-400">SFRA</span>
          ...
          <div class="mt-2 flex items-center space-x-1">
            <span class="text-sm font-medium text-gray-400">SG</span>
  ...
  <div>
        <div class="overflow-hidden bg-white rounded-md shadow-md">
          <div class="p-10">
            <h3 class="text-xs font-semibold tracking-widest text-purple-600 uppercase">SFCC Compatibility</h3>
            <ul class="flex flex-col mt-6 space-y-4">
              <li class="inline-flex items-center space-x-2">
                ...
                <span class="text-base font-medium text-gray-900">SFRA v6.2 Supported</span>
              </li>
              <li class="inline-flex items-center space-x-2">
                <svg class="w-5 h-5 text-green-600" fill="currentColor" viewBox="0 0 20 20">
                  <path fill-rule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0L2.98 10.414a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clip-rule="evenodd"/>
                </svg>
                <span class="text-base font-medium text-gray-900">Compatibility Mode ≤ 22.7</span>
              </li>
              <li class="inline-flex items-center space-x-2">
                <svg class="w-5 h-5 text-green-600" fill="currentColor" viewBox="0 0 20 20">
                  <path fill-rule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0L2.98 10.414a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clip-rule="evenodd"/>
                </svg>
                <span class="text-base font-medium text-gray-900">Backwards Compatible to SFRA 4.4.0</span>
              </li>
              <li class="inline-flex items-center space-x-2">
                ...
                <span class="text-base font-medium text-gray-900">SG Controllers Supported</span>
              </li>
              <li class="inline-flex items-center space-x-2">
                <svg class="w-5 h-5 text-red-500" fill="currentColor" viewBox="0 0 20 20">
                  <path fill-rule="evenodd" d="M10 2a8 8 0 100 16 8 8 0 000-16zm1 11H9v-2h2v2zm0-4H9V5h2v4z" clip-rule="evenodd"/>
                </svg>
                <span class="text-base font-medium text-gray-900">SG Pipelines Not Supported</span>
              </li>
            </ul>
