...
::alert{type="success" icon="lucide:lightbulb"}
  The difference between the product prices before and after the rounding model is applied is saved at <br>
  the order product line item level as **ESW Delta Rounding Values**.
::
