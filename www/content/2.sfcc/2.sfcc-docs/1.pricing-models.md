...
<div class="overflow-x-auto bg-white dark:bg-neutral-900 p-4 rounded-xl shadow-lg">
<caption class="caption-top text-base font-medium text-neutral-700 dark:text-neutral-300 mb-2">
      End-to-end flow of calculated pricing
    </caption>
<img class="w-full h-auto scale-100 hover:scale-130 ease-in duration-500 rounded-xl shadow-lg" src="/image-20210322-100427 (1).png" alt="Features Image">
</div>
