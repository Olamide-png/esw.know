  ...
  <div class="bg-teal-50 border-t-2 border-teal-500 rounded-lg p-4 dark:bg-teal-800/30" role="alert" tabindex="-1" aria-labelledby="hs-bordered-success-style-label">
    <div class="flex">
      ...
      <div class="ms-3">
        ...
        <p class="text-sm text-gray-700 dark:text-neutral-400">
          Based on these values, the final price that is displayed to the shopper is **PLN 388.16**.<br> 
          This is calculated as **Price of product in price book x FX rate**, <br>
          ```EUR 92 * 4.2191 = PLN 388.16```.
        </p>
      </div>
    </div>
  </div>
