...
Based on the following parameters, the final price displayed to the shopper is DKK **526.18**.

<br>

<div class="space-y-5">
  <div class="bg-blue-50 border-t-2 border-blue-500 rounded-xl shadow p-4 dark:bg-blue-800/30" role="alert" tabindex="-1" aria-labelledby="hs-bordered-success-style-label">
    <div class="flex">
      <div class="shrink-0">
      </div>
      <div class="ms-3">
