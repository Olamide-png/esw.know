...
<div class="space-y-5">
  <div class="bg-zinc-50 border-t-2 border-zinc-500 rounded-xl shadow p-4 dark:bg-zinc-800/30" role="alert" tabindex="-1" aria-labelledby="hs-bordered-success-style-label">
    <div class="flex">
      <div class="shrink-0">
      </div>
      <div class="ms-3">
