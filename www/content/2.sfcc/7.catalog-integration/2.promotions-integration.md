            ...
            <div class="grid md:grid-cols-2 gap-6">
              <div class="bg-gray-50 dark:bg-gray-800 rounded-md p-4">
                ...
                <ul class="text-sm text-gray-700 dark:text-gray-300 mt-2 space-y-1">
                  <li>✅ Amount Off</li>
                  <li class="text-neutral-600 dark:text-neutral-400">Discount amount is based on the retailer’s default currency or price book currency.</li>
                  <li class="text-neutral-600 dark:text-neutral-400">For Dynamic Pricing, the maximum discount cannot exceed final product price. Prices in cart may differ from PDP/PLP.</li>
                  <li>✅ Percentage Off</li>
                  <li class="text-neutral-600 dark:text-neutral-400">For Dynamic Pricing, cart prices may differ from PDP/PLP.</li>
                  <li>✅ Fixed Price</li>
            ...
            <div class="grid md:grid-cols-2 gap-6">
              <div class="bg-gray-50 dark:bg-gray-800 rounded-md p-4">
                ...
                <ul class="text-sm text-gray-700 dark:text-gray-300 mt-2 space-y-1">
                  <li>✅ Percent Off</li>
                  <li>✅ Amount Off</li>
                  <li class="text-neutral-600 dark:text-neutral-400">Amount Off is based on retailer’s default or price book currency.</li>
                  <li class="text-neutral-600 dark:text-neutral-400">Max discount cannot exceed final product price for Dynamic Pricing.</li>
                  <li>✅ Fixed Price</li>
                  <li>✅ Price From PriceBook</li>
