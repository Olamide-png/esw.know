...
#### :smart-icon{name="streamline-ultimate-color:mouse-smart" size=45} Navigate to the ESW Catalog Page  
Go to:  
**Merchant Tools > ESW > Catalog** in SFCC Business Manager.

#### :smart-icon{name="streamline-ultimate-color:monitor-sync" size=45} Perform Manual Product Sync  
...
#### :smart-icon{name="streamline-ultimate-color:settings-slider-desktop-horizontal" size=45} Use the Catalog Configuration View  
...
#### :smart-icon{name="streamline-ultimate-color:settings-cogwheel" size=45} Configure the API  
Ensure the **Catalog API** is correctly configured in SFCC Business Manager under the ESW service configuration.

#### :smart-icon{name="streamline-ultimate-color:checklist-check" size=45} Validate Product Data  
Navigate to:  
...
#### :smart-icon{name="streamline-ultimate-color:job-settings" size=45} Run the Job  
...
#### :smart-icon{name="streamline-ultimate-color:mouse-smart" size=45} Manual Testing (Optional)  
Navigate to:  
