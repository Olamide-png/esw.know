...
#### :smart-icon{name="streamline-ultimate-color:cog-search-1" size=45} Configure the API  
Ensure the **Catalog API** is correctly configured in SFCC Business Manager under the ESW service configuration.

#### :smart-icon{name="streamline-ultimate-color:checklist" size=45} Validate Product Data  
Navigate to:  
...
#### :smart-icon{name="streamline-ultimate-color:tags-settings" size=45} Run the Job  
