      ...
      <div class="py-8 px-6 text-center lg:flex-shrink-0 lg:flex lg:flex-col lg:justify-center lg:p-12 bg-gray-100 dark:bg-neutral-700">
        ...
        <div class="mt-6">
          <div class="rounded-md shadow">
            <a href="/content/apis/pricing-advisor-api/overview" class="flex items-center justify-center px-5 py-3 border border-transparent text-base font-medium rounded-md text-white bg-neutral-500 hover:bg-neutral-600">
              Read more
            </a>
          </div>
