...
| <div class="flex items-center gap-2"><smart-icon name="streamline-ultimate-color:server-add" size="20" class="dark:text-white"></smart-icon> <strong>Service Name</strong></div> | <div class="flex items-center gap-2"><smart-icon name="fxemoji:notepage" size="20" class="dark:text-white"></smart-icon> <strong>Description</strong></div> | <div class="flex items-center gap-2"><smart-icon name="streamline-ultimate-color:app-window-code" size="20" class="dark:text-white"></smart-icon> <strong>Interface</strong></div> | <div class="flex items-center gap-2"><smart-icon name="twemoji:alarm-clock" size="20" class="dark:text-white"></smart-icon> <strong>SLA</strong></div> | <div class="flex items-center gap-2"><smart-icon name="flat-color-icons:info" size="20" class="dark:text-white"></smart-icon> <strong>Notes</strong></div> |
|---|---|---|---|---|
