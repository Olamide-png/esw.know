...
Before accessing any ESW APIs—such as the **Pricing Advisor API**{style="color: tomato"}, **Checkout API**{style="color: tomato"}, or **Package API**{style="color: tomato"} — an Authentication API call is **required**.
...
#content
Full documentation on Pricing Advisor API v3.0, rounding direction, and model
::