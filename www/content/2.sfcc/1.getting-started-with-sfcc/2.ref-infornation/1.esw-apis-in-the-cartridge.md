...
<ul class="list-none md:grid md:grid-cols-3 md:gap-x-10 md:gap-y-10">
  <li class="bg-gray-100 dark:bg-neutral-800 text-center rounded-2xl shadow flex flex-col h-full">
    <div class="relative px-5 pt-16 pb-10 min-h-[320px] flex flex-col items-center">
...
<a href="https://know.esw.com/page/pricing-advisor-api" target="_blank" class="inline-flex items-center gap-1 text-sm text-neutral-600 hover:underline">
  <Icon name="lucide:terminal" class="w-40 h-40" />
...
::card-group
  ::card
  ---
  to: [Swagger Documentation](https://know.esw.com/page/pricing-advisor-api)
  target: _blank
  # showLinkIcon: false
