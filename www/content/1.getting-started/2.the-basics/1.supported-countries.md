...
<div class="flex flex-col md:flex-row gap-8">
  ...
  <div class="w-full md:w-1/2 space-y-6">
    <div>
      <h2 class="text-xl font-bold mb-2">Send a message</h2>
      <p class="text-sm text-gray-500 mb-4">POST <code class="bg-gray-100 text-pink-600 px-2 py-0.5 rounded text-xs font-mono">/v1/messages</code></p>
    ...
    <div>
      ...
      <ul class="space-y-4 border-l border-gray-300 dark:border-gray-700 pl-4">
        <li>
          <p><span class="font-mono font-medium text-blue-600">conversation_id</span> <span class="text-sm text-gray-500 italic">string</span></p>
          <p class="text-sm text-gray-700 dark:text-gray-300">
            Unique identifier for the conversation the message belongs to.
          </p>
        </li>
        <li>
          <p><span class="font-mono font-medium text-blue-600">message</span> <span class="text-sm text-gray-500 italic">string</span></p>
    ...
    <div>
      ...
      <ul class="space-y-4 border-l border-gray-300 dark:border-gray-700 pl-4">
        <li>
          <p><span class="font-mono font-medium text-blue-600">attachments</span> <span class="text-sm text-gray-500 italic">array</span></p>
          <p class="text-sm text-gray-700 dark:text-gray-300">
  ...
  <!-- Right Column: Request + Response Code Blocks -->
  <div class="w-full md:w-1/2 space-y-6 sticky top-4">
    <!-- Code Group: Request -->
    <div class="bg-neutral-900 rounded-xl p-4 text-white shadow">
      <h4 class="text-base font-semibold mb-2">Request</h4>
      <pre class="bg-neutral-800 rounded p-3 overflow-x-auto text-sm"><code class="language-bash">curl https://api.protocol.chat/v1/messages \
  ...
  -d message="You’re what the French call ‘les incompetents.’"
    ...
    <!-- Code Group: Response -->
    <div class="bg-neutral-900 rounded-xl p-4 text-white shadow">
      <h4 class="text-base font-semibold mb-2">Response</h4>
      <pre class="bg-neutral-800 rounded p-3 overflow-x-auto text-sm"><code class="language-json">{
  "id": "msg_1234567890",
  "status": "sent"
}
</code></pre>
