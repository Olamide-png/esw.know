...
<div class="overflow-x-auto p-4 bg-white dark:bg-slate-900 rounded-xl shadow">
  <table id="countryCurrencyTable" class="min-w-full table-auto text-left text-sm text-slate-700 dark:text-slate-300">
