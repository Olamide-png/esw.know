...
<body class="bg-white dark:bg-slate-900 text-slate-800 dark:text-slate-200 p-6">
  <div class="overflow-x-auto bg-white dark:bg-slate-900 rounded-xl shadow">
    <table id="countryCurrencyTable" class="min-w-full table-auto text-left text-sm">
