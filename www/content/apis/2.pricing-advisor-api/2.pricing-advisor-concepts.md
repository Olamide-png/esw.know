...
<section class="space-y-3">
  <h3 class="text-base font-semibold text-primary dark:text-primary-foreground">Up</h3>
  <p class="text-base text-primary dark:text-primary-foreground">
  ...
  <div class="rounded-lg border border-primary/10 dark:border-primary/30 bg-primary/5 dark:bg-primary/10 p-4">
    <ul class="list-disc marker:text-primary dark:marker:text-primary-foreground pl-5 space-y-1 text-primary dark:text-primary-foreground">
      <li>
...
<!-- Down -->
<section class="space-y-3 text-primary dark:text-primary-foreground">
  ...
  <div class="rounded-lg border border-primary/10 dark:border-primary/30 bg-primary/5 dark:bg-primary/10 p-4">
    <ul class="list-disc marker:text-primary dark:marker:text-primary-foreground pl-5 space-y-1">
      <li>
...
<div class="rounded-xl border border-primary/10 bg-primary/5 dark:border-primary/30 dark:bg-primary/10 p-5 text-sm text-primary dark:text-primary-foreground shadow-sm">
  <strong class="block mb-1 font-semibold">Info:</strong>
  Rounding models are the combination of one or more rounding methods that you would like to apply to a given value.
  For example:
  <code class="bg-primary/10 dark:bg-primary/20 px-1 py-0.5 rounded text-xs font-mono">none.fixed</code>,
  <code class="bg-primary/10 dark:bg-primary/20 px-1 py-0.5 rounded text-xs font-mono">fixed.multiple</code>,
  <code class="bg-primary/10 dark:bg-primary/20 px-1 py-0.5 rounded text-xs font-mono">multiple.none</code>, and so on.
</div>
