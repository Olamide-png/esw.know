...
<div class="mt-16 grid gap-8 sm:grid-cols-2 lg:grid-cols-3 p-4 md:p-8">
    ...
    <div
        ...
        <div class="space-y-12">
            ...
            <div class="space-y-4">
                <h3 class="text-2xl font-semibold text-gray-800 transition">Navigate</h3>
...
<div
        ...
        <div class="space-y-12">
            ...
            <div class="space-y-4">
                <h3 class="text-2xl font-semibold text-gray-800 transition">Click Link</h3>
...
<div
        ...
        <div class="space-y-12">
            ...
            <div class="space-y-4">
                <h3 class="text-2xl font-semibold text-gray-800 transition">Configure</h3>
