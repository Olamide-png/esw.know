...
Integrate the [downloaded ESW cartridge](https://esw-know.vercel.app/sfcc/getting-started/download-cartridge) into your SFCC instance by appending the appropriate cartridge path to the site’s **cartridge path configuration**. The required cartridge path will vary depending on the site’s architecture.
...
![Image](/image-20250729-113543(1).png){lifted}
::
