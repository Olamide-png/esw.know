...
::GlossaryInlineShadcn
  { enableAI=false maxPerTerm=3
    tooltipTextClass="text-lg md:text-xl leading-6"
    contentClass="rounded-2xl border border-border bg-card/95 dark:bg-popover/95 backdrop-blur-md px-3 py-2 shadow-lg"
  }
