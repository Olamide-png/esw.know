...
::tabs
  ...
  **Fallback:** If no fixed price is found, show `null` / `N/A`.
  ...
  ::tabs
    ::div{label="Rounding prices" icon="lucide:database"}
    ## Overview
  ...
  **Extend**
  ...
  <div class="bg-white dark:bg-neutral-900 p-4 rounded-xl shadow-lg">
    ...
    <img class="w-full rounded-xl shadow-lg" src="/image-20210322-102106.png" alt="How the price is displayed in the cart">
    <p class="mt-2 text-center text-sm text-neutral-700 dark:text-neutral-300">
  ...
  <div class="bg-white dark:bg-neutral-900 p-4 rounded-xl shadow-lg">
    ...
    <img class="w-full rounded-xl shadow-lg" src="/image-20210322-102116.png" alt="How the price is displayed at checkout">
    <p class="mt-2 text-center text-sm text-neutral-700 dark:text-neutral-300">
  ...
  <div class="bg-white dark:bg-neutral-900 p-4 rounded-xl shadow-lg">
    ...
    <img class="w-full rounded-xl shadow-lg" src="/image-20220128-102710(1).png" alt="Rounding Method - fixed">
    <p class="mt-2 text-center text-sm text-neutral-700 dark:text-neutral-300">
      <code>fixed</code>
    </p>
  </div>
  ...
  <div class="bg-white dark:bg-neutral-900 p-4 rounded-xl shadow-lg">
    <caption class="caption-center text-base font-medium text-neutral-700 dark:text-neutral-300 mb-2">
      Rounding Method - <code>fixed</code>
    </caption>
    <img class="w-full rounded-xl shadow-lg" src="/image-20210322-102208.png" alt="Rounding Method - fixed">
    <p class="mt-2 text-center text-sm text-neutral-700 dark:text-neutral-300">
  ...
  <div class="bg-white dark:bg-neutral-900 p-4 rounded-xl shadow-lg">
    ...
    <img class="w-full rounded-xl shadow-lg" src="/image-20210322-102231.png" alt="Rounding Method - fixed">
    <p class="mt-2 text-center text-sm text-neutral-700 dark:text-neutral-300">
  ...
  <div class="bg-white dark:bg-neutral-900 p-4 rounded-xl shadow-lg">
    ...
    <img class="w-full rounded-xl shadow-lg" src="/image-20220128-102733.png" alt="Rounding Method - multiple">
    <p class="mt-2 text-center text-sm text-neutral-700 dark:text-neutral-300">
      <code>multiple</code>
    </p>
  </div>
  ...
  <div class="bg-white dark:bg-neutral-900 p-4 rounded-xl shadow-lg">
    ...
    <img class="w-full rounded-xl shadow-lg" src="/image-20210322-102305.png" alt="Rounding Method - multiple">
    <p class="mt-2 text-center text-sm text-neutral-700 dark:text-neutral-300">
      <code>multiple</code>
    </p>
  </div>
  ...
  <div class="bg-white dark:bg-neutral-900 p-4 rounded-xl shadow-lg">
    <caption class="caption-center text-base font-medium text-neutral-700 dark:text-neutral-300 mb-2">
      Rounding Method - <code>multiple</code>
    </caption>
    <img class="w-full rounded-xl shadow-lg" src="/image-20210322-102320(1).png" alt="Rounding Method - multiple">
    <p class="mt-2 text-center text-sm text-neutral-700 dark:text-neutral-300">
      How the price is displayed in the cart
    </p>
  </div>
  ...
  <div class="bg-white dark:bg-neutral-900 p-4 rounded-xl shadow-lg">
    ...
    <img class="w-full rounded-xl shadow-lg" src="/image-20210322-102331.png" alt="Rounding Method - multiple">
    <p class="mt-2 text-center text-sm text-neutral-700 dark:text-neutral-300">
      How the price appear at checkout
    </p>
  </div>

  <div class="alert alert-success flex items-center gap-2 rounded-lg p-4 bg-green-50 dark:bg-green-900/30 border-l-4 border-green-500">
    <span class="mr-2"><svg class="lucide lucide-lightbulb" width="20" height="20" fill="none" stroke="currentColor" stroke-width="2"><circle cx="12" cy="12" r="10"/><path d="M9 18h6"/><path d="M10 22h4"/><path d="M12 2v2"/></svg></span>
    <span>
      The difference in product prices before and after the rounding model is applied is recorded at the order product line item level as the <strong>ESW Delta Rounding Value</strong>.
    </span>
  </div>
