...
::tabs{variant="line"}
 ...
 <th class="px-6 py-3">Environment</th>
    ...
    ####4 :smart-icon{name="lucide:circle-play" size=20} Run the Localized Promotions Job
    ...
    ####4 :smart-icon{name="lucide:file-up" size=20} Export and Apply Localized Promotions
