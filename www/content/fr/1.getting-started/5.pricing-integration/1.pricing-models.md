  ...
  **How it works.** Hybrid combines a fixed base price from SFCC price books with dynamic adjustments (FX, uplift, duties, taxes) when rules require it.
  ...
  ::tabs
    ...
    **Business Manager → Merchant Tools → Products and Catalogs → Import & Export**
    ...
    #### :smart-icon{name="streamline-ultimate-color:mouse" size=50 class="align-middle mr-2"} Import and Export

    Click the :shortcut{value="Import & Export" size="md"} module.

    #### :smart-icon{name="streamline-ultimate-color:mouse" size=50 class="align-middle mr-2"} Select Uploaded XML File
