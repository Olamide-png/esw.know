    ...
    <div class="ms-4">
      ...
      <div class="mt-2 text-sm text-red-700 dark:text-red-400">
        <ul class="list-disc space-y-1 ps-5">
          <li>
            The integration of the ESW Shopify Apps requires that you install, enable, and configure both, the International App and the Payment App for the solution to be functional.
          </li>
          <li>
