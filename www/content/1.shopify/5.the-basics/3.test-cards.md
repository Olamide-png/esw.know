...
::steps
  ...
  :MdCheck{id="install"} I have installed the app
  :MdAiHelp{query="Help with: Install the International App from ESW" extra-context="Shopify + ESW International App"}

  ### Confirm tenant configuration
  :MdCheck{id="tenant"} I have confirmed tenant configuration
  :MdAiHelp{query="Help with: Confirm tenant configuration with ESW onboarding manager"}

  ### Update brand configuration
  :MdCheck{id="brand-config"} I have updated brand configuration
  :MdAiHelp{query="Help with: Update brand configuration settings"}

  ### Verify storefront widgets
  :MdCheck{id="widgets"} I can see updated widgets on storefront
  :MdAiHelp{query="Help with: Verify storefront components reflect new configuration"}
::
