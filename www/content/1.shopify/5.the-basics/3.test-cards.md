...
:Walkthrough{ :steps="steps" persistKey="walkthrough:getting-started" @finish="onFinish" }
pnpm dlx nuxi@latest init my-app && cd my-app && pnpm i
</CodeBlock>
<CodeBlock label="npm" lang="bash">
npx nuxi@latest init my-app && cd my-app && npm i
</CodeBlock>
<CodeBlock label="yarn" lang="bash">
yarn dlx nuxi@latest init my-app && cd my-app && yarn
</CodeBlock>
</CodeGroup>
<div class="mt-3 text-sm text-muted-foreground">
Tip: Prefer <code>pnpm</code> for faster installs.
</div>
</div>


<!-- STEP 2: Install docs deps -->
<div v-else-if="step.id === 'install-mods'">
<CodeGroup>
<CodeBlock label="add modules" lang="bash">
pnpm add -D @ztl-uwu/nuxt-content shadcn-nuxt @nuxt/icon @nuxtjs/color-mode
</CodeBlock>
<CodeBlock label="nuxt.config.ts" lang="ts">
// nuxt.config.ts
...
<!-- STEP 3: Add a demo page -->
<div v-else-if="step.id === 'add-page'">
<CodeGroup>
<CodeBlock label="content page" lang="md">
---\ntitle: Hello Walkthrough\n---\n\n# It works!\n\nThis page is rendered by Nuxt Content.
</CodeBlock>
<CodeBlock label="app.vue" lang="vue">
...
<!-- STEP 4: Style + finish -->
<div v-else-if="step.id === 'style-finish'">
<ul class="list-disc pl-5 space-y-1">
<li>Add your brand colors in <code>tailwind.config.ts</code>.</li>
<li>Drop any code into <code>&lt;CodeGroup&gt;</code> tabs for multi-language samples.</li>
<li>Ship! 🎉</li>
</ul>
</div>
...
<script setup lang="ts">
const steps = [
{ id: 'init', title: 'Initialize a Nuxt 3 project', description: 'Create a fresh app using nuxi.' },
{ id: 'install-mods', title: 'Install documentation modules', description: 'Add Nuxt Content + shadcn docs UI.' },
{ id: 'add-page', title: 'Create your first content page', description: 'Verify content rendering.' },
{ id: 'style-finish', title: 'Polish styles & finish', description: 'Tailwind theme + final checks.' }
]


function onFinish() {
// Optional: toast, analytics, or navigate
