...
::card-group
  ...
  - A French <img src="https://flagcdn.com/w20/fr.png" alt="France" /> customer visiting `example.de` will not be automatically redirected to `example.fr`.
  ::
  ...
  - EU <img src="https://flagcdn.com/w20/eu.png" alt="EU" /> customers can be automatically redirected based on their location.
  ::
::
