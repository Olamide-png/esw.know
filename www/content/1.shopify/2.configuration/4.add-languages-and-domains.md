...
::tabs
  ::div{label="Meet Multi-Language Requirements" icon="lucide:globe"}
  Ensure your store is eligible and meets the requirements for selling in multiple languages.
  ::

  ::div{label="Theme & Checkout Support" icon="lucide:shopping-cart"}
  ...
  ::div{label="Providing Translations" icon="lucide:languages"}
  ...
  ::div{label="Publishing Without Translations" icon="lucide:alert-circle"}
  ...
  ::div{label="International Domains Requirement" icon="lucide:server"}
