...
::tabs
  ...
  ::div{label="Theme & Checkout Support" icon="streamline-ultimate-color:products-gifts"}
  ...
  ::div{label="Translations" icon="streamline-ultimate-color:conversation-sync"}
  ...
  ::div{label="Publishing Without Translations" icon="streamline-ultimate-color:conversation-sync"}
  ...
  ::div{label="Domains Requirement" icon="streamline-ultimate-color:browser-com"}
