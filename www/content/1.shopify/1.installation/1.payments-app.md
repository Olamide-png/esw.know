...
::steps
### :smart-icon{name="streamline-emojis:electric-plug" size=40} Install link
...
### :smart-icon{name="openmoji:charge-plug" size=40} Install app
...
### :smart-icon{name="fluent-color:person-add-20" size=40} Confirmation screen
