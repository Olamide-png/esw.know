...
<div class="flex w-full flex-col">
  <div class="card bg-base-300 rounded-box grid h-20 place-items-center">International App</div>
  <div class="divider">AND</div>
  <div class="card bg-base-300 rounded-box grid h-20 place-items-center">Payments App</div>
</div>
