...
<div class="flex w-full flex-col lg:flex-row">
  <div class="card bg-stone-300 rounded-lg shadow-lg grid h-32 grow place-items-center">International App</div>
  <div class="divider lg:divider-horizontal">AND</div>
  <div class="card bg-stone-300 rounded-lg shadow-lg grid h-32 grow place-items-center">Payments App</div>
</div>
