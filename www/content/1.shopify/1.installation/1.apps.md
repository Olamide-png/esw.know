...
<div class="flex justify-center my-4">
  <span class="inline-flex items-center px-4 py-2 bg-purple-100 dark:bg-purple-700/30 text-purple-900 dark:text-purple-100 font-semibold rounded-lg shadow-sm">
    International App
  </span>
</div>


<div class="flex my-2 text-sm font-semibold items-center text-gray-800 dark:text-gray-100">
  <div class="flex-grow border-t border-purple-200 dark:border-purple-400/60 h-px mr-3"></div>
  <span class="bg-purple-200 dark:bg-purple-500/30 text-purple-900 dark:text-purple-100 rounded-full p-1.5">AND</span>
  <div class="flex-grow border-t border-purple-200 dark:border-purple-400/60 h-px ml-3"></div>
</div>

<div class="flex justify-center my-4">
  <span class="inline-flex items-center px-4 py-2 bg-sky-100 dark:bg-sky-700/30 text-sky-900 dark:text-sky-100 font-semibold rounded-lg shadow-sm">
    Payments App
  </span>
</div>
