...
Install these apps to enable the ESW Shopify integration. These apps are interdependent and must be installed together.
...
<div class="flex flex-col items-center text-center space-y-2">
  <smart-icon name="streamline-ultimate-color:space-rocket-earth" size="50" />
  <span class="font-semibold text-lg">Install link</span>
</div>
