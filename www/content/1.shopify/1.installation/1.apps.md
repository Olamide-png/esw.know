...
<div class="flex my-2 text-sm font-semibold items-center text-gray-800 dark:text-gray-100">
  <div class="flex-grow border-t border-sky-200 dark:border-sky-400/60 h-px mr-3"></div>
  <span class="bg-sky-200 dark:bg-sky-500/30 text-sky-900 dark:text-sky-100 rounded-full p-1.5">AND</span>
  <div class="flex-grow border-t border-sky-200 dark:border-sky-400/60 h-px ml-3"></div>
</div>
