...
::tabs
  ...
  - **Seamless Global Reach** — International prices with duties and taxes included.
  - **Efficient Order Handling** — Shopify orders flow into ESW systems.
  - **Simplified Logistics** — Supports ESW forward shipping.
  - **Compliance Support** — Automates duty/tax declarations.
  ...
  #### :smart-icon{name="streamline-ultimate-color:laptop-user" size=50 class="align-middle mr-2"} Contact ESW onboarding manager
  After installation, contact the Onboarding Manager to configure your account, environment, and tenant.
  ...
  #### :smart-icon{name="streamline-ultimate-color:app-window-two" size=50 class="align-middle mr-2"} Confirmation screen
  You will see a confirmation screen once tenant setup is complete.
  ...
  #### :smart-icon{name="streamline-ultimate-color:tags-refresh" size=50 class="align-middle mr-2"} Update brand configuration settings
  Access and update brand settings via the ESP link.
  ...
  #### :smart-icon{name="streamline-ultimate-color:app-window-pie-chart" size=50 class="align-middle mr-2"} View installation in Shopify admin
  ...
  ESW localises payment options and uses a smart routing engine to improve success rates across markets.

  - Localised payment methods per market.
  - Local acquiring to improve approval rates.
  - Flexible models including Merchant of Record.
  - Secure, compliant processing with fraud protection.
  - Optimised checkout with highest-converting options.
  ...
  **Click** <kbd>Install</kbd> at the bottom of the installation screen.
  ...
  #### :smart-icon{name="streamline-ultimate-color:app-window-two" size=50 class="align-middle mr-2"} Confirmation screen
  You will get a confirmation screen once tenant configuration is complete.
