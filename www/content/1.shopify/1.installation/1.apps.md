...
<ul role="list" class="list-disc marker:text-teal-400 ...">
  ...
  <li>Efficient Order Handling: Orders are ingested <a href="/shopify/workflow/order-ingestion">directly</a> into ESW systems, streamlining fulfillment.</li>
  <li>Simplified Logistics: ESW’s forward shipping service, reducing complexity for cross-border delivery.</li>
  <li>Compliance Support: Submission of duty and tax declarations for compliance.</li>
</ul>
