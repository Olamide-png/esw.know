...
::steps
### :smart-icon{name="emojione:electric-plug" size=30} Install link
...
### :smart-icon{name="openmoji:electric-plug-red" size=30} Install app
...
### :smart-icon{name="fluent-color:person-add-20" size=30} Contact ESW onboarding manager
...
### :smart-icon{name="streamline-ultimate-color:app-window-two" size=30} Confirmation screen
...
### :smart-icon{name="noto:screwdriver" size=30} Update brand configuration settings
...
### :smart-icon{name="streamline-emojis:telescope" size=30} View installation in your Shopify admin
