...
<div class="container mx-auto p-10 md:py-20 px-0 md:p-10 md:px-0">
  <div class="relative px-10 md:p-0 transform duration-500 shadow-sm">
    ...
    <div class="content bg-white dark:bg-gray-900 p-2 pt-8 md:p-12 pb-12 lg:max-w-lg w-full lg:absolute top-48 left-2">
      <div class="flex justify-between font-bold text-sm">
        ...
        <p class="text-gray-400 dark:text-gray-300"></p>
      </div>
      ...
      <p class="my-3 text-justify font-medium text-gray-700 dark:text-gray-300 leading-relaxed">
        The configuration and integration is a managed process. After the apps are installed, please contact the ESW onboarding team.
      </p>
