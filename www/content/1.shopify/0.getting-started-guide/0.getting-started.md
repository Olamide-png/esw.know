...
<div class="container mx-auto p-4 md:py-4 px-0 md:p-10 md:px-0">
  <!-- Keep the max width on a wrapper, not the <img> -->
  <div class="relative mx-auto w-full xl:max-w-6xl shadow-lg">
    <!-- Aspect box reserves height immediately -->
    <div class="relative w-full aspect-[16/9]">
      <img
        src="/e9d97aa0-f187-47e8-ab8a-34c41cc5eac6.webp"
        alt=""
        class="absolute inset-0 h-full w-full object-cover"
        width="2400" height="1350"      <!-- intrinsic size prevents CLS -->
...
<!-- Overlay card -->
    <div
      class="content bg-white/85 dark:bg-gray-900/85 p-2 pt-8 md:p-12 pb-12
             lg:max-w-lg w-full lg:absolute lg:top-48 lg:left-2 rounded-lg shadow-lg"
    >
      ...
      <h2 class="text-3xl font-semibold mt-4 md:mt-10 text-black dark:text-white">
        Getting Started Guide
      </h2>
      <p class="my-3 text-justify font-medium text-black dark:text-white md:tracking-normal leading-relaxed">
      ...
      <a
        href="/shopify/getting-started-guide/getting-started#managed-process"
