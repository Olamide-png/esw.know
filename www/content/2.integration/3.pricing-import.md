...
Use the Pricing Advisor <Badge variant="outline" type="success" to="https://github.com/ZTL-UwU/shadcn-docs-nuxt" target="_blank" showLinkIcon="true">ESW API</Badge> icon="lucide:external-link" to fetch FX rates, uplifts, duties, taxes, and rounding rules for each market.
